  ...
  return (
    <Formik
      ...
      validationSchema={Yup.object({
        ...
        description: Yup.string().required("Debe completar este campo"),
        cost: Yup.string().required("Debe completar este campo"),
        sale: Yup.string().required("Debe completar este campo"),
        quantity: Yup.string().required("Debe completar este campo"),
        category: Yup.string().required("Debe completar este campo"),
      })}
